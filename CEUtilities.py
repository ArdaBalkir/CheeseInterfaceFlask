...
#model = tf.keras.models.load_model("model_23_02")

report_gen = [report_cheddar,report_cheddar,report_cheddar,
            report_cheddar,report_cheddar,report_cheddar]

def ce_prediction(image):
    ...
    current_report = return_gen[predicted_class](image)
